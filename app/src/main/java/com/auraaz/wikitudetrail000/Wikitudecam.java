package com.auraaz.wikitudetrail000;
...
public class Wikitudecam extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wikitudecam);
    ...
    protected void onPostCreate(Bundle savedInstanceState){
        ...
        try {
            this.architectView.load( "file:///android_asset/sample1/index.html" );
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
